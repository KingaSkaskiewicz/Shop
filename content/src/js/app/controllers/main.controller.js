app.controller('mainCtrl', function ($scope, $anchorScroll, $timeout, shoppingBasketService, $location) {
    ...
    $scope.shopItems = [
        {
            image: "Shop/content/dist/images/bedding-3528078_960_720.jpg",
            description: "POSCIEL BLUE LAGOON",
            price: 25.99,
            modal: "productModal1"
        },
        {
            image: "Shop/content/dist/images/carol-3890333_960_720.jpg",
            description: "LAMPKI COZY EVENING",
            price: 15.99,
            modal: "productModal2"
        },
        {
            image: "Shop/content/dist/images/cherry-blossoms-4069596_1280.jpg",
            description: "ZESTAW WAZONOW MONO",
            price: 19.99,
            modal: "productModal3"
        },
        {
            image: "Shop/content/dist/images/flower-951780_960_720.jpg",
            description: "DONICZKA SIMPLE LIFE",
            price: 8.99,
            modal: "productModal4"
        },
        {
            image: "Shop/content/dist/images/pillow-1738023_1280 (1).jpg",
            description: "PODUSZKA BASIC",
            price: 12.99,
            modal: "productModal5"
        },
        {
            image: "Shop/content/dist/images/tea-lights-1742638_1280.jpg",
